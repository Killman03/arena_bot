...
from .finance_edit_handlers import router as finance_edit_handlers_router
...
from .daily_reminders import router as daily_reminders_router
from .quick_actions import router as quick_actions_router
from .gladiator_punishments import router as gladiator_punishments_router
...
def setup_routers() -> Router:
    ...
    router.include_router(finance_edit_handlers_router)
    ...
    router.include_router(daily_reminders_router)
    router.include_router(quick_actions_router)
    router.include_router(gladiator_punishments_router)
